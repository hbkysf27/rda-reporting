<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" Inherits="RDA.Reports" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-5">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control mr-1" ID="txtstatus" runat="server" placeholder="Report Status" ReadOnly="True"></asp:TextBox>
