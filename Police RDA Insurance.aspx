...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">View Pending Accidents</button>
    ...
    <div class="collapse multi-collapse" id="multiCollapseExample2">
     ...
     <div class="col-md-7">
         ...
         <div class="card">
          ...
          <asp:GridView class="table table-striped tabel-bordered" ID="GridView3" runat="server"></asp:GridView>
      </div>
    </div>
  </div>
</div>
