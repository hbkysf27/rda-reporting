                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <center>
                            <br />
                           <div class="form-group">
                              <asp:Button class="btn btn-primary" ID="Button1" runat="server" Text="UPDATE ACCOUNT" />
                           </div>
                            <br />
                            <div class="form-group">
                              <asp:Button class="btn btn-danger" ID="Button2" runat="server" Text="DELETE ACCOUNT" />
                           </div>
